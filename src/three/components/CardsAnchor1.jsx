...
export function createCardsAnchor1(scene, camera, renderer, {
  getCardWidthPx,
  gapPx,
}) {
  ...
  function computeSnapTs() {
      ...
      const pathStartX = curve.points[0].x;
      const pathEndX = curve.points[curve.points.length - 1].x;
  ...
  function update(progress) {
    lastProgress = progress;
      ...
      const activeIndex = getClosestSnapIndex(curveT);
      ...
      curve.getPointAt(1 - curveT, anchor.position);
    }
